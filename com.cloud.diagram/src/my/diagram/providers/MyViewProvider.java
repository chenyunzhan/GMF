...
public class MyViewProvider extends AbstractProvider implements IViewProvider {
	...
	protected boolean provides(CreateDiagramViewOperation op) {
		return DatabaseEditPart.MODEL_ID.equals(op.getSemanticHint())
				&& MyVisualIDRegistry.getDiagramVisualID(getSemanticElement(op
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = MyVisualIDRegistry.getNodeVisualID(
					op.getContainerView(), domainElement);
		} else {
			visualID = MyVisualIDRegistry.getVisualID(op.getSemanticHint());
			if (elementType != null) {
				if (!MyElementTypes.isKnownElementType(elementType)
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		if (semanticHint == null) {
			visualID = MyVisualIDRegistry.getNodeVisualID(containerView,
					domainElement);
		} else {
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		case FKRelationEditPart.VISUAL_ID:
			return createFKRelation_4001(getSemanticElement(semanticAdapter),
	...
	public Node createTable_2001(EObject domainElement, View containerView,
		...
		node.setType(MyVisualIDRegistry.getType(TableEditPart.VISUAL_ID));
	...
	public Node createColumn_3001(EObject domainElement, View containerView,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(MyVisualIDRegistry.getType(ColumnEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
	 ...
	 * @generated
	 */
	public Edge createFKRelation_4001(EObject domainElement,
		...
		edge.setType(MyVisualIDRegistry.getType(FKRelationEditPart.VISUAL_ID));
