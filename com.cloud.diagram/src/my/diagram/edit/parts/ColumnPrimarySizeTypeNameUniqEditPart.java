 ...
 * @generated
 */
public class ColumnPrimarySizeTypeNameUniqEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public ColumnPrimarySizeTypeNameUniqEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = MyParserProvider
					.getParser(
							...
							getParserElement(),
							MyVisualIDRegistry
									.getType(my.diagram.edit.parts.ColumnPrimarySizeTypeNameUniqEditPart.VISUAL_ID));
		}
		return parser;
	}
