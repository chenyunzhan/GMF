...
import my.diagram.edit.policies.TableCanonicalEditPolicy;
import my.diagram.edit.policies.TableItemSemanticEditPolicy;
	...
	protected void createDefaultEditPolicies() {
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(
						MyVisualIDRegistry.TYPED_INSTANCE));
