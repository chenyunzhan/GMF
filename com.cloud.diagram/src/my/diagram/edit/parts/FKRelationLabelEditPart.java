...
import my.diagram.edit.policies.MyTextSelectionEditPolicy;
 ...
 * @generated
 */
public class FKRelationLabelEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				MyVisualIDRegistry
						.getType(my.diagram.edit.parts.FKRelationLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public FKRelationLabelEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new MyTextSelectionEditPolicy());
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE,
				new DatabaseEditPart.LinkLabelDragPolicy());
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(this, null,
					MyEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
