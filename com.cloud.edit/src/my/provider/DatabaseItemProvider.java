...
/**
 * This is the item provider adapter for a {@link my.Database} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DatabaseItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MyPackage.Literals.DATABASE__TABLES);
			childrenFeatures.add(MyPackage.Literals.DATABASE__FKRELATIONS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MyPackage.Literals.DATABASE__TABLES,
				 MyFactory.eINSTANCE.createTable()));

		newChildDescriptors.add
			(createChildParameter
				(MyPackage.Literals.DATABASE__FKRELATIONS,
				 MyFactory.eINSTANCE.createFKRelation()));
	}
