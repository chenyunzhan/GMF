...
/**
 * This is the item provider adapter for a {@link my.Column} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ColumnItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Column_primary_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Column_primary_feature", "_UI_Column_type"),
				 MyPackage.Literals.COLUMN__PRIMARY,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MyPackage.Literals.COLUMN__SIZE,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MyPackage.Literals.COLUMN__TYPE,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MyPackage.Literals.COLUMN__UNIQUE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Column.class)) {
			case MyPackage.COLUMN__PRIMARY:
			case MyPackage.COLUMN__SIZE:
			case MyPackage.COLUMN__TYPE:
			case MyPackage.COLUMN__UNIQUE:
